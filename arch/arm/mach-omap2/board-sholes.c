...
static struct omap_opp sholes_mpu_rate_table[] = {
	{0, 0, 0},
#ifdef CONFIG_MACH_SHOLES_CLOCK_MANUAL
       {CONFIG_MACH_SHOLES_FREQ_1, VDD1_OPP1, CONFIG_MACH_SHOLES_VSEL_1},
       {CONFIG_MACH_SHOLES_FREQ_2, VDD1_OPP2, CONFIG_MACH_SHOLES_VSEL_2},
       {CONFIG_MACH_SHOLES_FREQ_3, VDD1_OPP3, CONFIG_MACH_SHOLES_VSEL_3},
       {CONFIG_MACH_SHOLES_FREQ_4, VDD1_OPP4, CONFIG_MACH_SHOLES_VSEL_4},
       {CONFIG_MACH_SHOLES_FREQ_5, VDD1_OPP5, CONFIG_MACH_SHOLES_VSEL_5},
       {CONFIG_MACH_SHOLES_FREQ_6, VDD1_OPP6, CONFIG_MACH_SHOLES_VSEL_6},
       {CONFIG_MACH_SHOLES_FREQ_7, VDD1_OPP7, CONFIG_MACH_SHOLES_VSEL_7},
#endif
